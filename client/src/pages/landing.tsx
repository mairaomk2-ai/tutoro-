            ...
            <div className="flex-1 text-white lg:pr-8">
              ...
              <div className="flex flex-col gap-5 mb-12 max-w-md">
                <Link href="/register-student">
                  <Button 
                    size="lg"
                    className="group bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white text-xl px-10 py-7 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-bold w-full"
                ...
                <Link href="/register-teacher">
                  <Button 
                    size="lg"
                    className="group text-white text-xl px-10 py-7 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-bold border-2 w-full"
