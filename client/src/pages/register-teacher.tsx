...
export default function RegisterTeacher() {
  ...
  const registerMutation = useMutation({
    ...
    onSuccess: async (data: any) => {
      ...
      // Wait for token to be fully processed, then redirect
      setTimeout(() => {
        setLocation("/");
      }, 1000);
    },
        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold py-3 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-[1.02]"
